...
model_save_dir = r"./savemodel/BayesianRidge2/"  # 定义模型保存的目录
...
joblib.dump(
    best_model, os.path.join(model_save_dir, "bay.pkl")
)  # 将找到的最佳模型保存到文件
logger.info(
    "-------------------------------应用模型--------------------------------------"
)
...
results_plot_save_dir = r"./result/BayesianRidge2/"  # 定义结果图保存的目录
